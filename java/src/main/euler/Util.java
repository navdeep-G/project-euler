...
final class Util {
	...
	public static int totient(int n) {
		...
		int p = 1;
		for (int i = 2, end = Util.sqrt(n); i <= end; i++) {  // Trial division
...
// Fractions in the precise sense
final class FracUtil implements Comparable<FracUtil> {
	
	public final BigInteger numerator;    // Always coprime with denominator
	public final BigInteger denominator;  // Always positive
	
	
	public FracUtil(BigInteger numer, BigInteger denom) {
		if (denom.signum() == 0)
	...
	public FracUtil add(FracUtil other) {
		return new FracUtil(numerator.multiply(other.denominator).add(other.numerator.multiply(denominator)), denominator.multiply(other.denominator));
	}
	
	
	public FracUtil subtract(FracUtil other) {
		return new FracUtil(numerator.multiply(other.denominator).subtract(other.numerator.multiply(denominator)), denominator.multiply(other.denominator));
	}
	
	
	public FracUtil multiply(FracUtil other) {
		return new FracUtil(numerator.multiply(other.numerator), denominator.multiply(other.denominator));
	}
	
	
	public FracUtil divide(FracUtil other) {
		return new FracUtil(numerator.multiply(other.denominator), denominator.multiply(other.numerator));
	}
	
	
	public boolean equals(Object obj) {
		if (!(obj instanceof FracUtil))
			return false;
		FracUtil other = (FracUtil)obj;
		return numerator.equals(other.numerator) && denominator.equals(other.denominator);
	}
	
	
	public int compareTo(FracUtil other) {
